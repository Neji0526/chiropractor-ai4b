...
export const conditions: Condition[] = [
  {
    ...
    featuredImage: {
      ...
      alt: "A therapist treating a patient's lower back while they lie face down on a treatment table",
      width: 1400,
      height: 875,
    },
  ...
  },
  {
    ...
    featuredImage: {
      src: "/images/conditions/neck-pain.jpg",
      alt: "A clinician checking the neck and shoulder position of a standing patient",
      width: 1400,
      height: 875,
    },
  ...
  },
  {
    ...
    featuredImage: {
      src: "/images/conditions/sciatica.jpg",
      alt: "A clinician raising a patient's straightened leg to test how the nerve responds",
      width: 1400,
      height: 875,
    },
    relatedServices: ["back-pain-care", "chiropractic-adjustments"],
  ...
  },
  {
    ...
    featuredImage: {
      src: "/images/conditions/headaches.jpg",
      alt: "A person pressing their fingertips to both temples with their eyes closed",
      width: 1400,
      height: 875,
    },
  ...
  },
  {
    ...
    featuredImage: {
      src: "/images/conditions/sports-injuries.jpg",
      alt: "A therapist moving a patient's leg through a range of motion on a treatment table",
      width: 1400,
      height: 875,
    },
  ...
  },
  {
    ...
    featuredImage: {
      src: "/images/conditions/posture-strain.jpg",
      alt: "A clinician's hands resting on the shoulders of a seated patient to check their posture",
      width: 1400,
      height: 875,
    },
